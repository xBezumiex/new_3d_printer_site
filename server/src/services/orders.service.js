...
import { sendOrderConfirmation, sendOrderNotificationToAdmin, sendOrderStatusEmail } from './email.service.js';
...
export const updateOrderStatus = async (orderId, status) => {
  ...
  if (updatedOrder.user?.email) {
    await sendOrderStatusEmail(updatedOrder.user, updatedOrder, status);
  }
