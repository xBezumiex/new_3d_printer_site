...
export default function RegisterPage() {
  return (
    <div style={{
      ...
      {/* Ambient glow */}
      <div style={{ position: 'absolute', top: '40%', left: '50%', transform: 'translate(-50%,-50%)', width: 600, height: 600, background: 'radial-gradient(circle, rgba(249,115,22,0.07) 0%, transparent 60%)', pointerEvents: 'none' }} />
      {/* Grid */}
      <div className="grid-overlay" style={{ position: 'absolute', inset: 0, opacity: 0.5, pointerEvents: 'none' }} />

      <div style={{ width: '100%', maxWidth: 460, position: 'relative', zIndex: 2, animation: 'fadeUp 0.5s ease both' }}>
        {/* Logo */}
